...
A Discord bot that allows you to use gpt chatbots in discord! The bot not only allows each user to personalize their own bot names and profile images using webhooks, but also provides a range of useful features to enhance your experience.
